...
x <- read.csv("original_GSM2230757_human1_umifm_counts.csv.gz", header = TRUE, check.names = FALSE)
cell_clusters<-x[,2:3]
...
write.csv(new_labels,'beta_cell_groups_3_4_10_after_filtering.csv')

plot1 <- FeatureScatter(data, feature1 = "nCount_RNA", feature2 = "percent.mt")
plot2 <- FeatureScatter(data, feature1 = "nCount_RNA", feature2 = "nFeature_RNA")
plot2<-plot2+geom_line(aes(y = 2500), color = "blue", linetype = "dashed")+geom_line(aes(y = 200), color = "blue", linetype = "dashed")

jpeg("qc1_ref.jpg", quality = 100)

plot1
dev.off()

jpeg("qc2_ref.jpg", quality = 100)
